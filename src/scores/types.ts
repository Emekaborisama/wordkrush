...
export type ScoreEntry = {
   ...
   *
   * Optional because it is not universal: WordKrush comparison is an untimed streak and
...
/**
 * Which way is better for a given game. WordKrush comparison scores a streak (higher
