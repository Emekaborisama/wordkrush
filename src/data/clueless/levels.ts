...
export const CLUELESS_SOLO_LEVELS: readonly CluelessSoloLevel[] = [
  ...
  },
  {
    number: 25,
    puzzleNumber: 55,
    name: 'Daily Vault: Pressure Point',
    description: 'Keep pressing toward the closest meaning.',
    phase: 'daily',
    hintPolicy: 'none',
    hint: null,
  },
  {
    number: 26,
    puzzleNumber: 56,
    name: 'Daily Vault: Quiet Power',
    description: 'A fresh semantic trail is ready to run.',
    phase: 'daily',
    hintPolicy: 'none',
    hint: null,
  },
  ...
  },
  {
    number: 28,
    puzzleNumber: 58,
    name: 'Daily Vault: Crossing Line',
    description: 'A new route through meaning awaits.',
    phase: 'daily',
    hintPolicy: 'none',
    hint: null,
  },
  {
    number: 29,
    puzzleNumber: 59,
    name: 'Daily Vault: Departure Board',
    description: 'A fresh path through meaning is ready.',
    phase: 'daily',
    hintPolicy: 'none',
    hint: null,
  },
  {
    number: 30,
    puzzleNumber: 60,
    name: 'Daily Vault: Measured Moment',
    description: 'A steady trail through the vault awaits.',
    phase: 'daily',
    hintPolicy: 'none',
    hint: null,
  },
  {
    number: 31,
    puzzleNumber: 61,
    name: 'Daily Vault: Turning Point',
    description: 'A fresh motion through meaning awaits.',
    phase: 'daily',
    hintPolicy: 'none',
    hint: null,
  },
  {
    number: 32,
    puzzleNumber: 62,
    name: 'Daily Vault: Clean Slate',
    description: 'A fresh trail through meaning awaits.',
    phase: 'daily',
    hintPolicy: 'none',
    hint: null,
  },
  {
    number: 33,
    puzzleNumber: 63,
    name: 'Daily Vault: Clear Skies',
    description: 'Your next semantic path is ready to unfold.',
    phase: 'daily',
    hintPolicy: 'none',
    hint: null,
  },
  {
    number: 34,
    puzzleNumber: 64,
    name: 'Daily Vault: Fresh Start',
    description: 'A fresh semantic trail is ready to unfold.',
    phase: 'daily',
    hintPolicy: 'none',
    hint: null,
  },
