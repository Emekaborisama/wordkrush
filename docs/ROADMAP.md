...
- [ ] **Tuesday player email via Resend** (ST-86) — **Doing**; changelog + Wordfall Broadcast to confirmed Auth users after Wordfall’s Monday drop (D-054, D-062). Drafts via OpenRouter. Secrets on GitHub Environment `best-games`.
