...
- [ ] Apply `supabase/migrations/0001_init.sql`, `0002_leaderboard.sql`, `0003_global_scores.sql`, `0004_unique_username.sql`, and `0005_clueless_difficulty_leaderboards.sql` in the Supabase SQL editor
